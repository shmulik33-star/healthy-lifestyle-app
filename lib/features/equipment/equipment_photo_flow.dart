        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'בחר אם לצלם עכשיו או להשתמש בתמונה שכבר נמצאת בטלפון. לאחר הבחירה ננסה לזהות את הציוד אוטומטית.',
              ),
    ...
    try {
      ...
      setState(() {
        ...
        if (suggestion.recognized && suggestion.name.isNotEmpty) {
          ...
          _aiStatus =
              'לא הצלחתי לזהות את הציוד בוודאות. אפשר למלא את הפרטים ידנית.';
        }
      });
