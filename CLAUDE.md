...
## המצב הנוכחי (מעודכן ל-08.09.2026)

`main` כולל סנכרון ענן דו-כיווני מלא (Supabase) לכל הישויות: פרופיל, מטרות, ארוחות,
מזווה, רשימת קניות, משקל, מזונות אישיים, ציוד מותאם אישית. PR #25-#56 כולם ממוזגים
...
הפיתוח הנוכחי: לחזק את עמוד התזונה (תיעוד מהיר, הצעות AI אמיתיות), ואז מעבר עיצוב
כולל לממשק (יעד: אינטואיטיבי, קליל, צעיר ועכשווי — הפלטה הנוכחית ב-`AppTheme` היא
Material 3 גנרי, לא "סקסי").
